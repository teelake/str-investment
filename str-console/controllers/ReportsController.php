...
final class ReportsController extends BaseController
{
    ...
    public function export(): void
    {
        ...
        try {
            ...
            self::sendCsv(
                $name,
                ['id', 'customer_id', 'customer_name', 'status', 'principal_amount', 'rate_percent', 'interest_basis', 'period_months', 'created_at', 'disbursed_at', 'disbursement_funds_on', 'closed_at'],
                $rows
            );
        } catch (Throwable) {
