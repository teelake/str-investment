  ...
  <section class="console-dash__kpis" aria-label="Key metrics">
    <div class="console-dash__kpi">
      ...
      <?php if (str_console_authorize_route($g, 'customers.index')): ?>
        <a class="btn ghost" href="<?= htmlspecialchars($basePath . '/customers', ENT_QUOTES, 'UTF-8') ?>" style="margin-top: 14px; font-size: 13px; padding: 10px 14px; display: inline-flex;">Open list</a>
      <?php endif; ?>
    </div>
    <div class="console-dash__kpi">
      ...
      <?php if (str_console_authorize_route($g, 'loans.index')): ?>
        <a class="btn ghost" href="<?= htmlspecialchars($basePath . '/loans', ENT_QUOTES, 'UTF-8') ?>" style="margin-top: 14px; font-size: 13px; padding: 10px 14px; display: inline-flex;">Open list</a>
      <?php endif; ?>
    </div>
    <div class="console-dash__kpi">
